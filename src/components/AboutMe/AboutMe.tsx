        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="text-2xl flex-col max-w-2xl mx-auto space-y-4">
            ...
            <p>
              ...
              on a SaaS platform for automotive workshops and helping ship
              features that solve real problems. I also have experience with
              tests like unit, E2E and regression, authentication, dashboards,
              and CI/CD pipelines — always aiming to write code that’s both
              thoughtful and useful. I believe in team work, clear
